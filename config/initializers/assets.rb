...
Rails.application.config.assets.precompile += %w( bootstrap-1.4.1-datepicker.min.js )
Rails.application.config.assets.precompile += %w( bootstrap-datepicker.da.min.js )
Rails.application.config.assets.precompile += %w( select.css )
Rails.application.config.assets.precompile += %w( select.scss )
